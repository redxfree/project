# Generated by Django 4.0.5 on 2022-06-04 10:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ManyToManyField(to='online.book')),
                ('products', models.ManyToManyField(to='online.product')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='book',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='online.category'),
        ),
        migrations.AddField(
            model_name='book',
            name='created_by',
